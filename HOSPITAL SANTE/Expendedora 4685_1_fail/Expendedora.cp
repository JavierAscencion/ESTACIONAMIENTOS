...
#line 26 "d:/proyectos/parking/hospital sante/expendedora 4685/ticket.h"
const char ticket[] = {
 ...
 "g\x05011F\x020100\n"
#line 66 "d:/proyectos/parking/hospital sante/expendedora 4685/ticket.h"
...
#line 330 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 wiegand26_enable();
 DS1307_Read(&myRTC,  1 );

 pilaBufferCAN = mysql_count_forced(tableEventosCAN, eventosEstatus, '1');
#line 340 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 INTCON.PEIE = 1;
 INTCON.GIE = 1;
#line 459 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 delay_ms(timeAwake);
#line 463 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 lcd_clean_row(1);
...
#line 489 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 delay_ms(50);
...
#line 510 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
...
#line 581 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
...
#line 596 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }


 if(buscarID){
 if(!mysql_search(tableSoporte, soporteID, id, &fila)){
#line 609 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 lcd_clean_row(3);
 lcd_out(3,1,"Tarjeta bloqueada");
 buscarID =  0 ;
#line 626 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
...
#line 689 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else{
 if(vigencia == ESTATUS_NOT){
 acceso[1] = TPV_NO_VIGENCIA;
 lcd_clean_row(2);
 lcd_out(2, 1, "Vigencia terminada");
#line 697 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else if(estatus == ESTATUS_MOD){
 acceso[2] = TPV_PASSBACK;
 lcd_clean_row(2);
 lcd_out(2,1,"Passback activo");
#line 704 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 ...
 lcd_clean_row(2);
 lcd_out(2,1,"Acceso aceptado");
#line 751 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else{
 if(saldo < 3600){
 acceso[1] = TPV_SIN_SALDO;
 lcd_clean_row(2);
 lcd_out(2,1,"Saldo terminado");
#line 759 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else if(estatus == ESTATUS_MOD){
 acceso[2] = TPV_PASSBACK;
 lcd_clean_row(2);
 lcd_out(2,1,"Passback activo");
#line 766 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
...
#line 796 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 lcd_clean_row(2);
 lcd_out(2,1,"Acceso aceptado");
#line 846 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else{
 if(saldo < 3600){
 acceso[1] = TPV_SIN_SALDO;
 lcd_clean_row(2);
 lcd_out(2,1,"Saldo agotado");
#line 854 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else if(estatus == ESTATUS_MOD){
 acceso[2] = TPV_PASSBACK;
 lcd_clean_row(2);
 lcd_out(2,1,"Passback activo");
#line 861 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 ...
 fecha[12] = 0;
 DS1307_read(&myRTC,  0 );
#line 899 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
...
#line 932 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else if(estatus == '0'){
 acceso[2] = TPV_PASSBACK;
 lcd_clean_row(2);
 lcd_out(2,1,"NIP desconocido*");
#line 941 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else if(isOtherToday || seconds >= TOLERANCIA_OUT){
 acceso[1] = TPV_OUT_TIME;
 lcd_clean_row(2);
 lcd_out(2,1,"NIP invalido*");
#line 948 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
...
#line 957 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 acceso[3] = TPV_DESCONOCIDO;
 string_add(canCommand,acceso);
 }
...
void expendedora_imprimir(){
 ...
 string_add(bufferEeprom, msjConst);
 buffer_save_send( 0 , bufferEeprom);
#line 991 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 string_add(bufferEeprom, msjConst);
 buffer_save_send( 0 , bufferEeprom);
#line 1007 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
...
#line 1021 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 return;
 }
...
#line 1031 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
...
#line 1059 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
...
#line 1074 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 abrirBarrera =  1 ;
 SALIDA_RELE1 = 1;
 SALIDA_RELE2 = 1;
 timer1_reset();
 ...
 cont = 0;
#line 1124 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
...
#line 1165 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 if(estatus == '1'){
...
#line 1179 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 return;
 }
 }
...
#line 1211 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 limpiarLCD =  1 ;
 tempLCD = 0;
 lcd_clean_row(3);
 lcd_out(3,17,"MSG");
...
#line 1253 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 if(id == idConsulta){
#line 1283 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 mysql_write(tablePensionados, pensionadosID, fila, idNew,  0 );
 mysql_write(tablePensionados, pensionadosVigencia, fila, vigencia,  0 );
 mysql_write(tablePensionados, pensionadosEstatus, fila, estatus,  0 );
 }
 ...
 if(!mysql_read(tablePensionados,pensionadosID, fila, &id)){
 if(id == idConsulta){
#line 1302 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 mysql_write(tablePensionados, pensionadosVigencia, fila, vigencia,  0 );
 }
 }
 ...
 if(!mysql_read(tablePensionados, pensionadosID, fila, &id)){
 if(id == idConsulta){
#line 1319 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 mysql_write(tablePensionados, pensionadosEstatus, fila, estatus,  0 );
 }
 }
 ...
 if(!mysql_read(tablePensionados, pensionadosID, fila, &id)){
 if(idConsulta == id){
#line 1334 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 mysql_read_string(tablePensionados, pensionadosVigencia, fila, &vigencia);
 mysql_read_string(tablePensionados, pensionadosEstatus, fila, &estatus);
...
#line 1363 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 string_add(bufferEeprom, msjConst);
 buffer_save_send( 1 , bufferEeprom);
#line 1377 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
...
#line 1424 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 }
 }else if(string_cmpnc(CAN_ACTUALIZAR, &can.rxBuffer[sizeTotal], sizeKey)){
 ...
 mysql_write(tablePrepago, prepagoSaldo, fila, saldo,  0 );
 mysql_write(tablePrepago, prepagoEstatus, fila, estatus,  0 );
#line 1461 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 }else if(string_cmpnc(CAN_CONSULTAR, &can.rxBuffer[sizeTotal], sizeKey)){
 ...
 numToHex(can.id, msjConst, 1);
 string_add(bufferEeprom, msjConst);
#line 1487 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else{
 string_addc(bufferEeprom, CAN_TABLE_NO_FOUND);
 }
 }
 ...
 if(id == idConsulta){
 mysql_write(tablePrepago, prepagoNip, fila, nip,  0 );
#line 1509 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 ...
 if(id == idConsulta){
 mysql_write(tablePrepago, prepagoSaldo, fila, saldo,  0 );
#line 1527 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 }else if(string_cmpnc(CAN_PASSBACK, &can.rxBuffer[sizeTotal], sizeKey)){
 ...
 if(id == idConsulta){
 mysql_write(tablePrepago, prepagoEstatus, fila, estatus,  0 );
#line 1544 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
...
#line 1566 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 ...
 mysql_write(tablePrepago, prepagoEstatus, fila, estatus,  0 );
 mysql_write(tablePrepago, prepagoSaldo, fila, saldo,  0 );
#line 1589 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 }else{
 string_addc(bufferEeprom, CAN_TABLE_ERROR);
...
#line 1620 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 if(idConsulta == id){
#line 1637 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 string_addc(bufferEeprom, CAN_MODULE);
 numToHex(can.id, msjConst, 1);
 string_add(bufferEeprom, msjConst);
 }else{
...
#line 1673 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 string_add(bufferEeprom, msjConst);
#line 1695 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else{
 string_addc(bufferEeprom, CAN_TABLE_NO_FOUND);
 }
 }else if(string_cmpnc(CAN_PASSBACK, &can.rxBuffer[sizeTotal], sizeKey)){
 ...
 buffer_save_send( 1 , bufferEeprom);
#line 1820 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 buffer_save_send( 1 , bufferEeprom);
#line 1846 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 buffer_save_send( 1 , bufferEeprom);
#line 1867 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 ...
 buffer_save_send( 1 , bufferEeprom);
#line 1907 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 ...
 string_add(bufferEeprom, msjConst);
 buffer_save_send( 1 , bufferEeprom);
#line 1928 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else if(string_cmpnc(CAN_TABLE_SET, &can.rxBuffer[sizeTotal], sizeKey)){
 sizeTotal += sizeKey;
 string_cpyn(msjConst, &can.rxBuffer[sizeTotal], 8);
 folio = hexToNum(msjConst);
 mysql_write(tableFolio, folioTotal, 1, folio,  0 );
#line 1937 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
 }
}
...
#line 1952 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }else if(can.tx_status == CAN_RW_CORRUPT){

 if(!modeBufferEventos){
 buffer_save_send( 1 , can.txBuffer);
#line 1960 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }else{

 modeBufferEventos =  0 ;
#line 1966 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
}
...
#line 2010 "D:/PROYECTOS/PARKING/HOSPITAL SANTE/Expendedora 4685/Expendedora.c"
 }
 }
}
