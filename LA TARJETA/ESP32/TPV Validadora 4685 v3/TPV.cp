#line 1 "D:/PROYECTOS/PARKING/LA TARJETA/TPV Validadora 4685 v3/TPV.c"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/miscelaneos.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/string.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/miscelaneos.h"
#line 6 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/string.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/_lib_cryptography.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_wtd.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_timer1.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_timer2.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_timer3.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_usart.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/string.h"
#line 13 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_usart.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_can.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/miscelaneos.h"
#line 40 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_can.h"
...
#line 110 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_can.h"
typedef struct{
...
void can_set_baud(unsigned int speed_us){
 char Tqp, pre;
#line 408 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_can.h"
 speed_us *= Clock_MHz();
 speed_us /= 2;
...
void can_interrupt( char  enable,  char  hihgPriprity){
 ...
 PIE3.TXB1IE = enable;
 PIE3.TXBnIE = enable;
#line 792 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_can.h"
}
...
void int_can(){
#line 822 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_can.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/ds1307.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/miscelaneos.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/string.h"
#line 19 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/ds1307.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/impresora_termica.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/miscelaneos.h"
#line 6 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/impresora_termica.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/table_eeprom.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/eeprom_i2c_soft.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/i2c_soft.h"
#line 10 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/i2c_soft.h"
...
#line 6 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/eeprom_i2c_soft.h"
extern sfr sbit I2C_SCL;
extern sfr sbit I2C_SCLD;
extern sfr sbit I2C_SDA;
extern sfr sbit I2C_SDAD;
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/miscelaneos.h"
#line 34 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/table_eeprom.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/wiegand26.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_external_int0.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_external_int1.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lib_timer2.h"
#line 36 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/wiegand26.h"
 ...
 *nip +=  ((char*)&WIEGAN26_BUFFER)[i] ;
 ...
 char  wiegand26_read_key(char *keys){
 static char wiegand_cont_past = 0;
 short i;


 if(WIEGAN26_CONT % 8 == 0 && WIEGAN26_CONT != 0){
 if(WIEGAN26_CONT == wiegand_cont_past)
 return  0 ;

 Delay_ms(_WIEGAND26_PULSE_TIME_MAX_MS);

 if(WIEGAN26_CONT % 8 != 0)
 return  0 ;


 wiegand_cont_past = WIEGAN26_CONT;
 WIEGAN26_BUFFER = WIEGAN26_DATA;


 if(!wiegand26_checkTouch(WIEGAN26_CONT/8))
 return  0 ;


 for(i = 0; i < WIEGAN26_CONT/8; i++){
  ((char*)&WIEGAN26_BUFFER)[i]  &= 0x0F;
 if( ((char*)&WIEGAN26_BUFFER)[i]  == 0x0A ||  ((char*)&WIEGAN26_BUFFER)[i]  == 0x0B){
 ...
 for(i = 0; i < WIEGAN26_CONT/8 && i < 4; i++){
 keys[i] =  ((char*)&WIEGAN26_BUFFER)[WIEGAN26_CONT/8-1-i]  + '0';
 }
 keys[i] = 0;
 return  1 ;
 }
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/__netethenc28j60.h"
typedef struct {
 char remoteIP[4];
 char remoteMAC[6];
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/spi_tcp.h"
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/miscelaneos.h"
#line 3 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/spi_tcp.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lcd_4x20.h"
...
#line 27 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/lcd_4x20.h"
...
#line 1 "d:/proyectos/parking/la tarjeta/tpv validadora 4685 v3/servidor.h"
const char pageWeb[] =
"<!DOCTYPE html>"
"<html>"
"<body> "
...
"</html>"
;
#line 45 "D:/PROYECTOS/PARKING/LA TARJETA/TPV Validadora 4685 v3/TPV.c"
...
const char TCP_CAN_VAL[] = "VAL";
const char TCP_CAN_IDX[] = "IDX";
...
const char ESTATUS_PAS = TCP_CAN_MODULE_V[0] == 'E'? 'O':'I';
const char ESTATUS_MOD = TCP_CAN_MODULE_V[0] == 'E'? 'I':'O';
...
void pic_init(){
 ...
 INTCON.PEIE = 1;
 INTCON.GIE = 1;
#line 598 "D:/PROYECTOS/PARKING/LA TARJETA/TPV Validadora 4685 v3/TPV.c"
...
#line 619 "D:/PROYECTOS/PARKING/LA TARJETA/TPV Validadora 4685 v3/TPV.c"
 Delay_ms(timeAwake);
 lcd_clean_row(1);
...
void validadora_barrera(){
 ...
 string_cpyc(bufferEeprom, CAN_BAR);
...
void validadora_checkTarjeta(){
 ...
 string_cpyc(canCommand, TCP_CAN_SOPORTE);
 ...
 numToHex(canIdVal, msjConst, 1);
 string_add(canCommand, msjConst);
 buffer_save_send( 1 , canCommand, tarjetas.canIdMod);
 }
 }
 ...
 string_addc(canCommand, TCP_CAN_IDX);
 numToHex(id, msjConst, 3);
 string_add(canCommand, msjConst);
 string_add(canCommand, &myRTC.time[1]);
 ...
 numToHex(canIdVal, msjConst, 1);
 string_add(canCommand, msjConst);
 buffer_save_send( 1 , &canCommand[3], tarjetas.canIdMod);
 }else if(buscarNIP){
 buscarNIP =  0 ;
 ...
 string_cpyc(canCommand, TCP_CAN_TPV);
 string_addc(canCommand, TCP_CAN_NIP);
 numToString(nip, msjConst, 4);
 string_add(canCommand, msjConst);
 string_add(canCommand, &myRTC.time[1]);
...
#line 1515 "D:/PROYECTOS/PARKING/LA TARJETA/TPV Validadora 4685 v3/TPV.c"
 }
}
...
void Net_Ethernet_28j60_UserTCP(SOCKET_28j60_Dsc *socket){
 ...
 for(fila = 1; fila <= myTable.rowAct; fila++)
 mysql_write(&getRequest[sizeTotal], pensionadosEstatus, fila, '-',  0 );

 if(!mysql_write(&getRequest[sizeTotal], pensionadosEstatus, 1, '-',  0 ))
 string_addc(respuesta, TCP_TBL_MODIFICADO);
 else
 string_addc(respuesta,TCP_TBL_ERROR);
 }else{
 ...
 usart_write_line(&getRequest[sizeTotal]);
